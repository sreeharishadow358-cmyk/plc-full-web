export function rejectMissingSealIn(rung) {
...
export function rejectSafetyInputWiredNormallyOpen(rung) {
...
export function rejectOneSidedMutexInterlock(program) {
...
export function rejectDuplicateOutputCoil(program) {
  if (!program || !program.rungs) return { status: "valid" };

  const coilAddressCount = {};
...
export function validateLadderProgram(program) {
...
export function validateSingleRung(rung, rungIndex) {
...
export function isValidMitsubishiAddress(addr) {
